...
<div class="container">
	<div class="grid">
		<div class="row">
            <div class="border padding20 span10" style="background-color: #86CCED;">
			...
			<div class="padding20 span4" style="background-color: #F1EDA9;">
				<div class="panel no-border">
                    <div class="panel-header ribbed-cyan fg-white">Waktu Sekarang</div>
                    <div class="panel-content fg-dark nlp nrp">
						<center><div class="calendar" data-role="calendar"></div></center> <br />
						<div class="times" data-role="times" data-style-background="bg-lightGreen" data-style-divider="fg-lightGreen"></div>
                    </div>
				</div>
